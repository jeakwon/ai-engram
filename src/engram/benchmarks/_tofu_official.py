"""The official TOFU metrics, ported verbatim from open-unlearning.

This is a faithful transcription of the reference implementation the paper's numbers come from —
kept separate from :mod:`engram.benchmarks.tofu` so it can be diffed against upstream. Validated
against the framework's cached ``TOFU_SUMMARY.json``: exact_memorization 0.9737 vs 0.9739,
